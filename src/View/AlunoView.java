...
public class AlunoView {
  ...
  public Aluno salvar() {
	...
	/*
	 * public void atualizar() { Aluno a = new Aluno();
	 * System.out.println("Digite o código do aluno: ");
	 * a.setId(Integer.parseInt(jIn.nextLine()));
	 * System.out.println("Digite o novo nome do aluno: ");
	 * a.setNome(jIn.nextLine()); aControle.atualizar(a); }
	 */
  ...
  public void listar(){
	  ...
	  for (Aluno aluno : alunos) {
          ...
          System.out.print(" ID cidade: " + aluno.getCidade().getId_cidade() + " Nome: " + aluno.getCidade().getNome_cidade());
          System.out.println(" ID estado: " + aluno.getCidade().getEstado().getId_estado() + " Nome: " + aluno.getCidade().getEstado().getNome_estado());
      }
  }

	/*
	 * public void excluir() { System.out.println("Digite o código do aluno: ");
